...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'tx_des_sec_tem'); ?>
		<?php echo $form->textField($model,'tx_des_sec_tem',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'tx_des_sec_tem'); ?>
	</div>

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'tx_nom_op'); ?>
	...
	<div class="row">
		...
		<?php //echo $form->dropDownList($model,'id_entado', array()); ?>
		<?php //echo $form->error($model,'id_entado'); ?>
		
		
		<?php echo $form->labelEx($model,'Estidad'); ?>
		<?php echo $form->dropDownList($model,'id_entado', CHtml::listData(Estado::model()->findAll(), 'id_estado', 'tx_des_estado')); ?>			
		<?php echo $form->error($model,'id_entado'); ?>
	</div>

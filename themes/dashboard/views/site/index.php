            ...
            <div class="jarviswidget" id="wid-id-6" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <form action="http://192.241.236.31/test2.smartadmin/ajax/php/demo-comment.php" method="post" id="comment-form" class="smart-form">
                            <header>
                                Comment form
                            </header>
            ...
            <div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <form action="http://192.241.236.31/test2.smartadmin/ajax/demo-contacts.php" method="post" id="contact-form" class="smart-form">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <img src="img/logo.html" width="150" alt="SmartAdmin">
                </h4>
            </div>
